...
test('Outstanding Purchase Report (Management)', async ({
  page,
  ai,
  aiAssert,
  aiQuery
  ...
  await page.goto(`${reporturl.url}/Report/Management/RptOutstandingPurchaseMgmt.aspx`);
  ...
  await type(page, "//input[@id='txtSupplier']", supplierName);
