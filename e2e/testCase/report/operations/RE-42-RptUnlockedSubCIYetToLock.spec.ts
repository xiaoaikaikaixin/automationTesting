...
test('Unlocked Sub CI But Yet To Lock', async ({ 
    page,
    ai,
    aiAssert,
    aiQuery
 }) => {
  test.info().title = 'Unlocked Sub CI But Yet To Lock';

  await page.goto(`${reporturl.url}Report/Operation/RptUnlockedSubCIYetToLock.aspx`);
