...
test('Trade Limit Checking (Invoice)', async ({ 
    page,
    ai,
    aiAssert,
    aiQuery
 }) => {
  test.info().title = 'Trade Limit Checking (Invoice)';

  await page.goto(`${reporturl.url}Report/Operation/RptTradeLimitCheckingInvoice.aspx`);
