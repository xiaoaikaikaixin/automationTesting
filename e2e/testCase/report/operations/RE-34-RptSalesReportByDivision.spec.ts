...
test('Sales Report By Division', async ({ 
    page,
    ai,
    aiAssert,
    aiQuery
 }) => {
  test.info().title = 'Sales Report By Division';

  await page.goto(`${reporturl.url}Report/Operation/RptSalesReportByDivision.aspx`);
