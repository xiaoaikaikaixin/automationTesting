...
test('Sales By Products With Customer Name Qty Fac', async ({ 
    page,
    ai,
    aiAssert,
    aiQuery
 }) => {
  test.info().title = 'Sales By Products With Customer Name Qty Fac';

  await page.goto(`${reporturl.url}Report/Operation/RptSalesByProductsWithCustomerNameQtyFac.aspx`);
  ...
  // Enter Product Code
  await type(page, "//input[@id='txtProductCode']", productCode);
