...
test('Outstanding Sales And Purchase Report', async ({ 
    page,
    ai,
    aiAssert,
    aiQuery
 }) => {
  test.info().title = 'Outstanding Sales And Purchase Report';

  await page.goto(`${reporturl.url}Report/Operation/RptOutstandingSalesAndPurchase.aspx?ReportType=SalesAndPurchase`);
