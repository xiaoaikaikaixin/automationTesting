...
test('Shipment Activity Report with TC/PC and Broker Details', async ({ 
    page,
    ai,
    aiAssert,
    aiQuery
 }) => {
  test.info().title = 'Shipment Activity Report with TC/PC and Broker Details';
  ...
  // Enter Broker Name
  await type(page, "//input[@id='txtBrokerName']", brokerName);
